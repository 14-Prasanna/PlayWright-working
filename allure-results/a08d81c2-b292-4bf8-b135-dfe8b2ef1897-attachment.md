...
```ts
  ...
  13 | 
  14 |     const display_msg = page.locator("//div[@id = 'user-message']//p[@id = 'message']");
  15 | 
  16 |     const input_value = await input_field.inputValue();  
  17 | 
> 18 |     await expect(page.locator('#message')).toContainText('prasanna');
     |                                            ^ Error: expect(locator).toContainText(expected) failed
  19 | 
  20 |     console.log("input field", input_field);
  21 | 
  22 | 
  23 | });
  24 | 
