...
- Location: tests\Assessment.test.ts:32:5
        ...
        - generic [ref=e60]:
          ...
          - generic [ref=e63]:
            - generic [ref=e65]:
              ...
              - textbox "Please enter first value" [ref=e67]: "25"
              - paragraph [ref=e68]: Enter second value
              - textbox "Please enter second value" [ref=e69]: "10"
...
```ts
  ...
  38 |     console.log(await sum1.boundingBox())
  39 |     sum1.fill(a);
  40 | 
  41 |     console.log(await sum1.inputValue())
  42 | 
  43 |     const sum2 = await page.locator("#sum2");
  44 |     console.log(await sum2.boundingBox())
  45 |     sum2.fill(b);
  46 | 
  47 |     console.log(await sum2.inputValue())
  48 | 
  49 |     await page.getByRole('button', { name: 'Get Sum' }).click();
  50 |     
  51 |     const display = await page.locator("#addmessage")
  52 | 
> 53 |     console.log(await display.inputValue());
     |                               ^ Error: locator.inputValue: Error: Node is not an <input>, <textarea> or <select> element
  54 | 
  55 |     expect(display).toBe("35");
  56 |     
  57 | })
  58 | 
  59 | test.afterEach(async({page}) => {
