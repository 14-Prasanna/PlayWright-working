...
Call log:
  ...
  - waiting for locator('#sum2')
    12 × locator resolved to <input id="sum2" type="text" placeholder="Please enter second value" class="border border-gray-550 w-full h-35 rounded px-10"/>
       - unexpected value ""
